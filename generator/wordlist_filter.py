"""
Filterlogik für deutsche Rohlisten.
Wird vom Management Command import_wordlist aufgerufen.
"""
import re
...
class SyllableAnalyzer:
    # y wird im Deutschen vokalisch gesprochen (wie ü)
    ...
    def all_syllables_anchored(self, word: str) -> bool:
        return all(
            any(ch in self.VOWELS for ch in syllable)
    ...
    def is_shuffle_suitable(self, word: str) -> bool:
        ...
        return (
            ...
            and self.all_syllables_anchored(word)
        )
...
class WordlistFilter:
    def __init__(self, config: FilterConfig | None = None):
        ...
        self._syllables = SyllableAnalyzer()
    ...
    def _enrich(self, word: str) -> dict:
        ...
        anchored = self._syllables.all_syllables_anchored(word)
        return {
            "word":                  word,
